...
3. **High-Load Simulation (Local Docker Cluster)**:
   - **Why local?** No free cloud provider in the world (Supabase, Neon, Upstash) allows 10,000 RPS. Upstash Redis free tier caps at 10,000 commands *per day* (exhausted in 1 second at 10k RPS).
