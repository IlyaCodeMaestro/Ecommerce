  ...
  useEffect(() => {
    const loadCatalog = async () => {
      ...
      try {
        ...
        console.warn(
          "Backend unavailable, using fallback mock catalog for UI preview:",
          err,
        );
        setProducts(FALLBACK_PRODUCTS);
      } finally {
      ...
      <section className="relative overflow-hidden border-b border-slate-800 bg-gradient-to-b from-slate-900/60 to-slate-950/20 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="mt-4 text-sm sm:text-base text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Multi-tier L1 Memory &amp; L2 Redis caching with singleflight
            stampede guard, atomic Lua stock reservations, and asynchronous
            Kafka event buffering to PostgreSQL.
          </p>
